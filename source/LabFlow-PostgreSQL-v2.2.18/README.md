...
`v2.2.18` 是基于 PostgreSQL 的样品送样、分析检测工作量与样品信息管理系统版本，包含统一 Excel 式导出模板编辑器、固定公式导出和人员变动通知流程。
...
从发布目录下载 `样品管理系统_v2.2.18_PostgreSQL服务器版_Setup.exe`。
...
详细 Ubuntu 交付与验收步骤见 `docs/Ubuntu部署与Linux安装_v2.2.18.md`。
