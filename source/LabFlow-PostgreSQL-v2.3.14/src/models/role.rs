...
pub const PERMISSIONS: &[PermissionDef] = &[
    ...
    PermissionDef {
        key: "sample:record-workload",
        label: "录入取样工作量（研发送样）",
        full_label: "分析检测-研发送样取样后录入工作量",
        group: "门户入口",
        portal: Some("分析检测门户"),
        actor: Some("检测人员"),
    },
    ...
    PermissionDef {
        key: "sample-info:record-workload",
        label: "录入取样工作量（样品信息）",
        full_label: "分析检测-样品信息取样后录入工作量",
        group: "门户入口",
        portal: Some("分析检测门户"),
        actor: Some("检测人员"),
    },
...
mod tests {
    ...
    fn seeded_management_permissions_are_accepted() {
        ...
        assert!(is_valid_permission("sample:record-workload"));
        assert!(is_valid_permission("sample-info:record-workload"));
