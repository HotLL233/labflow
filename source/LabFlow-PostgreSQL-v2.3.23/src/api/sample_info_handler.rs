...
async fn sample_workload_preview(
    ...
    let first_coefficient = instruments
        .first()
    ...
    Ok(Json(ApiResponse::ok(SampleInfoWorkloadPreview {
        ...
        remaining_quantity: (record.quantity as i32
            - crate::repo::record_repo::sample_info_source_quantity(&pool, id)?)
        .max(0),
        ...
        instruments,
        recorded: crate::repo::record_repo::sample_info_source_quantity(&pool, id)?
