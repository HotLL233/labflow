  ...
  const recordDisplayWidths = useMemo(() => {
    ...
    const inputs = [
      ...displayColumns.map(column => {
        ...
        const custom = override || column.width_mode === 'custom';
    ...
    return Object.fromEntries(
      Object.entries(layouts).map(([key, item]) => [key, { desktop: item.percent, mobile: item.px }]),
    );
  }, [
  ...
  return (
    ...
    <Box sx={{ width: '100%', maxWidth: 1536, mx: 'auto', mt: { xs: 1, md: 2 }, px: { xs: 0, sm: 1 } }}>
      ...
      <SampleInfoRecordList
        ...
        actionCollapsed={actionColumnMode === 'auto'}
