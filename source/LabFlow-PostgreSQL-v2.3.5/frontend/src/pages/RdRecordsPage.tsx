                    ...
                    <TableCell sx={{ ...recordCellSx, ...adaptiveCellSx(adaptiveWidths.actions), px: 0.5, textAlign: 'center', whiteSpace: 'nowrap' }}>
                      {isEditing ? (
                        ...
                        <Box sx={{ display: 'inline-flex', gap: 0.25, alignItems: 'center' }}>
                          ...
                          {canRecordSampleWorkload && <Button size="small" variant="outlined" onClick={() => openSampleWorkload(rec.id)} sx={{ minWidth: 0, px: 0.6, fontSize: '0.68rem', borderRadius: R }}>录入工作量</Button>}
