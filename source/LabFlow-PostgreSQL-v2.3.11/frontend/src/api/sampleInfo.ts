...
export const createSampleInfoWorkload = (id: number, data: { method_id: number; quantity: number; multiplier: number; notes?: string }): Promise<ApiResponse<import('../types').WorkRecord>> =>
